...
public class FloatingActionButtonLayout extends ViewGroup {
    ...
    public FloatingActionButtonLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                mFabMode = FabMode.values()[ta.getInt(R.styleable
                        .FloatingActionButtonLayout_umanoFabMode, DEFAULT_FAB_MODE.ordinal())];
            }
            ta.recycle();
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childcount != 2) {
            throw new IllegalStateException("FloatingActionButtonLayout must have exactly 2 " +
                    "children");
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            int expandedYSpace = getMeasuredHeight() - mSlidingUpPanelLayout.getChildAt(1)
                    .getMeasuredHeight();
            ...
            horizontalGravity = GravityCompat.getAbsoluteGravity(horizontalGravity, ViewCompat
            ...
            int collapsedfabBottom = b - mSlidingUpPanelLayout.getPanelHeight() +
                    mFloatingActionButton.getMeasuredHeight() / 2;
            int collapsedfabTop = collapsedfabBottom - mFloatingActionButton.getMeasuredHeight();
            int expandedfabBottom = t + expandedYSpace + mSlidingUpPanelLayout.getPanelHeight() +
                    mFloatingActionButton.getMeasuredHeight() / 2;
            ...
            switch (state) {
                ...
                case ANCHORED:
                    ...
                    if (anchor != 1.0f) {
                        fabBottom = t + Math.round((getMeasuredHeight() - mSlidingUpPanelLayout
                                .getPanelHeight()) * (1f - anchor) + mFloatingActionButton
                                .getMeasuredHeight() / 2);
            ...
            mSlidingUpPanelLayout.attachFloatingActionButton(mFloatingActionButton,
                    initialfabTop, collapsedfabTop, expandedfabTop, expandedYSpace, mFabMode);
        }
     ...
     *
     * @return integer with the desired visibility (is one of either View.VISIBLE, View.INVISIBLE
     * or View.GONE)
     */
     ...
     * (call this instead of the standard setVisibility() so the code can handle visibility while
     * sliding)
     *
     * @param visibility integer with the desired visibility (must be one of either View.VISIBLE,
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable
                    .FloatingActionButtonLayout_LayoutParams);
            gravity = a.getInt(R.styleable
                    .FloatingActionButtonLayout_LayoutParams_android_layout_gravity, gravity);
            a.recycle();
        }
